...
CREATE TABLE `mats_color` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `lid` int(10) unsigned NOT NULL COMMENT '二级产品id',
  `title` varchar(255) NOT NULL COMMENT '颜色名称',
  `img` varchar(255) NOT NULL COMMENT '颜色图',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='入口垫产品详情 颜色表';
...
CREATE TABLE `mats_info` (
  ...
  `pid` int(10) unsigned NOT NULL COMMENT '产品一级分类id',
  `tid` int(10) unsigned NOT NULL COMMENT '产品二级分类id',
  `title` varchar(255) NOT NULL COMMENT '产品型号',
  `tubiao` varchar(255) NOT NULL COMMENT '产品图标',
  ...
  `zhaobiao_excel` varchar(255) NOT NULL COMMENT '招标文件',
...
CREATE TABLE `mats_ress` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='入口垫产品详情 参考表';
...
CREATE TABLE `mats_ship` (
  ...
  `img` varchar(255) NOT NULL COMMENT '图',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='入口垫产品详情 饰品 表';
...
-- Records of mats_two
-- ----------------------------
INSERT INTO `mats_two` VALUES ('0000000001', '1', '/static/upload/a5bf260d5b85f6d4/7104b39838944800.jpg|/static/upload/07adabd75b35d0a7/3433dc87c6789687.jpg|/static/upload/07c8f659ecc51b1b/23ce7effaf112c36.jpg', '/static/upload/b8b5e3f6e66bc0a1/97a3b0fedca058c8.jpg', '带螺纹地毯垫', '可更换刀片效果出色。适用于平均访客人数的住宅楼宇和商业楼宇。非常适合拾取细小的污垢。', '2019-03-13 13:28:20');
INSERT INTO `mats_two` VALUES ('0000000002', '1', '/static/upload/a5bf260d5b85f6d4/7104b39838944800.jpg|/static/upload/556ecca328345298/f92eaf4e38ea4957.jpg|/static/upload/07c8f659ecc51b1b/23ce7effaf112c36.jpg', '/static/upload/b56908eda4377063/93b575ab3b0dc478.jpg', '带罗纹地毯插件和刷条', '成功的附加配件：刷子额外的清洁效果！非常适合拾取细小的污垢。', '2019-03-13 13:28:44');
INSERT INTO `mats_two` VALUES ('0000000003', '1', '/static/upload/a5bf260d5b85f6d4/7104b39838944800.jpg|/static/upload/556ecca328345298/f92eaf4e38ea4957.jpg|/static/upload/e1081d8cb21504cb/be0da223c685e133.jpg', '/static/upload/1061716344a014bf/af579a0a06ab812c.jpg', '带罗纹地毯插件和刮刀杆', '成功的附加配件：刮板杆，提供额外的清洁效果！非常适合拾取细小的污垢。', '2019-03-13 13:29:18');
INSERT INTO `mats_two` VALUES ('0000000004', '1', '/static/upload/a5bf260d5b85f6d4/7104b39838944800.jpg|/static/upload/556ecca328345298/f92eaf4e38ea4957.jpg|/static/upload/07adabd75b35d0a7/3433dc87c6789687.jpg|/static/upload/07c8f659ecc51b1b/23ce7effaf112c36.jpg', '/static/upload/c5759267f3a03050/ec0fc4b46b4ed981.jpg', '带罗纹地毯插入物和卡式刷', '1区和2区的全方位选择。适用于住宅楼，行政大楼和平均访客数量的商业楼宇。适合拾取粗糙和细小的污垢', '2019-03-13 13:27:21');
...
INSERT INTO `system_log` VALUES ('259', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-13 21:34:27');
...
) ENGINE=InnoDB AUTO_INCREMENT=204 DEFAULT CHARSET=utf8 COMMENT='系统菜单表';
...
INSERT INTO `system_menu` VALUES ('200', '194', '入口垫二级分类产品详情', '', '', '/tuanj/matsinfo/index', '', '_self', '0', '1', '0', '2019-03-12 22:23:20');
INSERT INTO `system_menu` VALUES ('201', '194', '入口垫产品颜色设置', '', '', '/tuanj/matscolor/index', '', '_self', '0', '1', '0', '2019-03-13 21:47:56');
INSERT INTO `system_menu` VALUES ('202', '194', '入口垫产品饰品设置', '', '', '/tuanj/matsship/index', '', '_self', '0', '1', '0', '2019-03-13 21:48:33');
INSERT INTO `system_menu` VALUES ('203', '194', '入口垫产品参考设置', '', '', '/tuanj/matsress/index', '', '_self', '0', '1', '0', '2019-03-13 21:49:00');
