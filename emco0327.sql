...
-- ----------------------------
-- Table structure for `contact_service`
-- ----------------------------
...
CREATE TABLE `mats_services` (
  ...
  `title1` varchar(200) NOT NULL COMMENT '标题',
  `s_title1` varchar(255) NOT NULL COMMENT '小标题',
  `content1` text NOT NULL COMMENT '内容',
  `img2` varchar(255) NOT NULL COMMENT '图2 ',
  `title2` varchar(255) NOT NULL,
  `s_title2` varchar(255) NOT NULL COMMENT '小标题',
  `content2` text NOT NULL,
  `tel` char(20) NOT NULL COMMENT '电话',
  `top_title` varchar(200) NOT NULL COMMENT '头部标题',
  `img3` varchar(255) NOT NULL,
  `title3` varchar(200) NOT NULL,
  `s_title3` varchar(255) NOT NULL,
  `video` varchar(255) NOT NULL COMMENT '视频地址',
  `content3` text NOT NULL,
  `img4` varchar(255) NOT NULL,
  `title4` varchar(255) NOT NULL,
  `s_title4` varchar(255) NOT NULL,
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=264 DEFAULT CHARSET=utf8 COMMENT='系统操作日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=225 DEFAULT CHARSET=utf8 COMMENT='系统菜单表';
...
INSERT INTO `system_menu` VALUES ('208', '207', '入口垫服务', '', '', '/tuanj/matsservice/index', '', '_self', '0', '1', '0', '2019-03-27 15:03:42');
