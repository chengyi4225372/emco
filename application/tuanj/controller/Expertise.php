...
class Expertise extends BasicAdmin {

    private $dataform = 'about_expertise';

    public function index() {
        $this->title = '关于我们设置-专业知识';
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/expertise/index')];
