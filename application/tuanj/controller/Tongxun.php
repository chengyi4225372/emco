...
class Tongxun extends BasicAdmin
{
    private $dataform = 'tongxun_contact';

    public function index() {
        $this->title = '订购emco时事通讯列表';
        list($get, $db) = [$this->request->get(), Db::name($this->dataform)];
        (isset($get['keywords']) && $get['keywords'] !== '') && $db->whereLike('name|email', "%{$get['keywords']}%");
