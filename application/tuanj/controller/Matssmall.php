...
class Matssmall extends BasicAdmin {

    private $dataform = 'service_img';

    public function index() {
        $this->title = '入口垫底部小图设置';
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/matssmall/index')];
