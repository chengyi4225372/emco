...
class Protucts extends BasicAdmin {

    private $dataform = 'protucts';
...
//    private $cate = 'news_cate';
    ...
    public function index() {
        ...
        (isset($get['keywords']) && $get['keywords'] !== '') && $db->whereLike('ptitle', "%{$get['keywords']}%");
...
//            $db->whereBetween('create_at', [$start_time, $end_time]);
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/protucts/index')];
