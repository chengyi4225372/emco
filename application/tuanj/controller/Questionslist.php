...
class Questionslist extends BasicAdmin {

    private $dataform = 'questions_lists';

    public function index() {
        $this->title = '遇到的问题-问题列表';
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/questionslist/index')];
