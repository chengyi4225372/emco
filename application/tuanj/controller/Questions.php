...
class Questions extends BasicAdmin {

    private $dataform = 'question_img';

    public function index() {
        $this->title = '遇到的问题-展示图文';
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/questions/index')];
